...
export default function Navbar({ onOpenSearch, onOpenMenu }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mj-container-wide">
          <ul className="mj-hide-scrollbar-x flex items-stretch justify-start gap-0.5 2xl:justify-center">
            {CATEGORY_NAV.map((item) => {
              ...
              const itemClasses = cn(
                'group/cat relative flex items-center gap-2.5 whitespace-nowrap px-3 font-sans text-label transition-colors duration-300 lg:px-3.5 xl:px-4',
      ...
      >
        <div className="mj-container-wide">
          <ul className="mj-hide-scrollbar-x flex items-center justify-start gap-x-7 py-2.5 lg:gap-x-9 2xl:justify-center">
