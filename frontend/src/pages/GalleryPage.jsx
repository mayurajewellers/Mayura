...
import { GALLERY_GROUPS as STATIC_GROUPS, GALLERY_ITEMS as STATIC_ITEMS } from '@data/gallery'
...
export default function GalleryPage() {
  ...
  const [itemsList, setItemsList] = useState(() => STATIC_ITEMS)
  ...
  const items = useMemo(() => {
    if (group === 'All') return itemsList
    return itemsList.filter((item) => item.group === group)
  }, [group, itemsList])
