...
export default function ProductPage() {
  ...
  const [product, setProduct] = useState(() => getStaticProductBySlug(slug))
    ...
    productService
      ...
      .then((res) => {
        ...
        if (res.success && res.product) {
          ...
          // Fallback to static product if available
          const staticFallback = getStaticProductBySlug(slug)
          if (staticFallback) setProduct(staticFallback)
        }
      })
      .catch(() => {
        if (!isSubscribed) return
