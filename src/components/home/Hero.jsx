 ...
 *
 * Each slide is a split composition — a colour field carrying the type and a
 * photograph alongside it — so the headline stays live text (responsive,
 * translatable, readable by assistive tech) instead of being baked into an
 * image. Neighbouring slides peek in at the gutters, autoplay pauses on hover
 * and on focus, and the whole thing is operable from the keyboard.
 */
