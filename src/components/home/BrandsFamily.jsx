...
import { BRANDS_FAMILY } from '@data/homepage'
 ...
 *
 * Until the client supplies official logo artwork (brand.logo), each house
 * renders as an elegant serif wordmark — see BRANDS_FAMILY in data/homepage.
 */
