  ...
  return (
    <>
      <PageHero
        eyebrow="Checkout"
        title="Almost there"
        lede="This checkout is a demonstration — no payment is taken and no data leaves your browser. It exists so you can see exactly how the finished flow will look."
        breadcrumbs={[
              ...
              <Reveal>
                <fieldset>
                  ...
                  <div className="grid gap-7 sm:grid-cols-2">
                    <TextField label="First name" name="firstName" required autoComplete="given-name" placeholder="Darshil" />
                    <TextField label="Last name" name="lastName" required autoComplete="family-name" placeholder="Bhandari" />
                    <TextField label="Email address" name="email" type="email" required autoComplete="email" placeholder="you@example.com" />
                    <TextField label="Mobile number" name="phone" type="tel" required autoComplete="tel" placeholder="+91 00000 00000" />
                  </div>
                </fieldset>
              </Reveal>
              ...
              <Reveal>
                <fieldset>
                  ...
                  <div className="grid gap-7 sm:grid-cols-2">
                    ...
                    />
                    <TextField label="City" name="city" required autoComplete="address-level2" placeholder="Mumbai" />
                    <SelectField label="State" name="state" options={STATES} required defaultValue="Maharashtra" />
                    <TextField label="PIN code" name="pincode" required inputMode="numeric" autoComplete="postal-code" placeholder="400101" />
                    <TextField label="Country" name="country" defaultValue="India" readOnly />
                    <TextArea
              ...
              <Reveal>
                <fieldset>
                  ...
                  <p className="mb-8 max-w-xl text-body-sm leading-[1.9] text-charcoal-200">
                    No payment gateway is connected to this website. Selecting a method here simply
                    records a preference — we will confirm the day’s gold rate and send you a payment
                    link or bank details directly.
                  </p>
            ...
            <div className="lg:col-span-5 xl:col-span-4">
              <div className="lg:sticky lg:top-32">
                <div className="mj-panel p-7 sm:p-8">
                  ...
                  >
                    Demonstration only — nothing is charged. Reach us on {CONTACT.phonePrimary} to
                    place a real order.
                  </p>
                </div>
              </div>
