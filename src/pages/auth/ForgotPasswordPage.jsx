      ...
      <AnimatePresence mode="wait">
        ...
        {step === 0 && (
          ...
          >
            ...
            <p className="mt-5 text-body-sm leading-[1.9] text-charcoal-200">
              Enter the email address on your account and we will send a six-digit code to it.
            </p>
        ...
        {step === 1 && (
          ...
          >
            ...
            <p className="mt-5 text-body-sm leading-[1.9] text-charcoal-200">
              We would have sent a six-digit code to{' '}
              <span className="text-charcoal">{email || 'your email'}</span>. This is a
              demonstration, so type any six digits.
            </p>
        ...
        {step === 3 && (
          ...
          >
            ...
            <p className="mx-auto mt-5 max-w-sm text-body-sm leading-[1.9] text-charcoal-200">
              In a live version your password would now be updated. Because this site has no
              backend, nothing was changed and nothing you typed left your browser.
            </p>
