...
export const consultationConfirmedTemplate = (consultation) => {
  ...
  const subjectLine = 'Consultation confirmed — Mayura Jewellers'
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .status-badge { display: inline-block; background: #E6F4EA; color: #137333; border: 1px solid #CEEAD6; padding: 6px 12px; font-size: 13px; font-weight: bold; border-radius: 4px; text-transform: uppercase; }
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p style="margin: 4px 0 0 0; font-size: 13px; color: #8C827A;">Personal Consultation Confirmation</p>
          </div>
          <div class="content">
            <p>Dear ${name},</p>
            <p>Great news! Your <strong>${type.toUpperCase()}</strong> jewellery consultation has been officially confirmed by our showroom team.</p>
            <div style="margin: 16px 0;"><span class="status-badge">Status: CONFIRMED</span></div>
            <div class="details">
              <p style="margin: 0 0 8px 0; font-weight: bold;">Confirmed Appointment Details:</p>
              <p style="margin: 4px 0;">📅 <strong>Date:</strong> ${dateStr}</p>
              <p style="margin: 4px 0;">⏰ <strong>Time:</strong> ${timeSlot}</p>
            </div>
            <p>We look forward to showcasing our finest designs to you. If you have any questions before our appointment, please reach us on WhatsApp at +91 91675 89002.</p>
...
Great news! Your ${consultation.consultationType || 'video'} jewellery consultation has been officially confirmed by our showroom team.
...
We look forward to showcasing our finest designs to you. If you have any questions before our appointment, please reach us on WhatsApp at +91 91675 89002.
